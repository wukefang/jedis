...
public class BinaryClient extends Connection {
    ...
    public void ehexpire(final byte[] key, final byte[] field, final int seconds) {
        sendCommand(EHEXPIRE, key, field, toByteArray(seconds));
    }
    ...
    public void ehexpireAt(final byte[] key, final byte[] field, final long unixTime) {
        sendCommand(EHEXPIREAT, key, field, toByteArray(unixTime));
    }
    ...
    public void ehttl(final byte[] key, final byte[] field) {
        sendCommand(EHTTL, key, field);
    }
    ...
    public void ehset(final byte[] key, final byte[] field, final byte[] value) {
        sendCommand(EHSET, key, field, value);
    }
    ...
    public void ehget(final byte[] key, final byte[] field) {
        sendCommand(EHGET, key, field);
    }
    ...
    public void ehsetnx(final byte[] key, final byte[] field, final byte[] value) {
        sendCommand(EHSETNX, key, field, value);
    }
    ...
    public void ehmset(final byte[] key, final Map<byte[], byte[]> hash) {
        final List<byte[]> params = new ArrayList<byte[]>();
        params.add(key);
        ...
        sendCommand(EHMSET, params.toArray(new byte[params.size()][]));
    }

    public void ehmsetex(List<byte[]> keyAndEntries) {
        sendCommand(EHMSETEX, keyAndEntries.toArray(new byte[keyAndEntries.size()][]));
    }
    ...
    public void ehmget(final byte[] key, final byte[]... fields) {
        sendCommand(EHMGET, joinParameters(key, fields));
    }
    ...
    public void ehincrBy(final byte[] key, final byte[] field, final long value) {
    ...
    public void ehexists(final byte[] key, final byte[] field) {
        sendCommand(EHEXISTS, key, field);
    }
    ...
    public void ehdel(final byte[] key, final byte[]... fields) {
        sendCommand(EHDEL, joinParameters(key, fields));
    }
    ...
    public void ehlen(final byte[] key) {
        sendCommand(EHLEN, key);
    }
    ...
    public void ehkeys(final byte[] key) {
        sendCommand(EHKEYS, key);
    }
    ...
    public void ehvals(final byte[] key) {
        sendCommand(EHVALS, key);
    }
    ...
    public void ehgetAll(final byte[] key) {
        sendCommand(EHGETALL, key);
    }
    ...
    public void ehincrByFloat(final byte[] key, final byte[] field, final double increment) {
        sendCommand(EHINCRBYFLOAT, key, field, toByteArray(increment));
    }
    ...
    public void ehstrlen(final byte[] key, final byte[] field) {
        sendCommand(EHSTRLEN, key, field);
    }

    public void ehsetex(byte[] key, byte[] field, byte[] value, int seconds) {
        sendCommand(EHSETEX, key, field, value, toByteArray(seconds));
    }
}
