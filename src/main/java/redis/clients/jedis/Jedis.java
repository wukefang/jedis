...
public class Jedis extends BinaryJedis implements JedisCommands, MultiKeyCommands,
    ...
    public Long ehexpire(final String key, final String field, final int seconds) {
        checkIsInMultiOrPipeline();
        client.ehexpire(key, field, seconds);
        return client.getIntegerReply();
    }
    ...
    public Long ehexpireAt(final String key, final String field, final long unixTime) {
        checkIsInMultiOrPipeline();
        client.ehexpireAt(key, field, unixTime);
        return client.getIntegerReply();
    }
    ...
    public Long ehset(String key, String field, String value) {
        checkIsInMultiOrPipeline();
        client.ehset(key, field, value);
        return client.getIntegerReply();
    }

    public String ehsetex(String key, String field, String value, int seconds) {
        checkIsInMultiOrPipeline();
        client.ehsetex(key, field, value, seconds);
        return client.getBulkReply();
    }
    ...
    public String ehget(String key, String field) {

        checkIsInMultiOrPipeline();
        client.ehget(key, field);
        return client.getBulkReply();
    }
    ...
    public Long ehsetnx(final String key, final String field, final String value) {
        checkIsInMultiOrPipeline();
        client.ehsetnx(key, field, value);
        return client.getIntegerReply();
    }
    ...
    public String ehmset(final String key, final Map<String, String> hash) {
        checkIsInMultiOrPipeline();
        client.ehmset(key, hash);
        return client.getStatusCodeReply();
    }
    ...
    public static class TemporaryEntry {
        ...
        public TemporaryEntry(String field, String value) {
            this.field = field;
            this.value = value;
        }

        public TemporaryEntry(String field, String value, int seconds) {
            this.field = field;
            this.value = value;
            this.seconds = seconds;
        }
    }
    public String ehmsetex(final String key, TemporaryEntry... temporaryEntries) {
        checkIsInMultiOrPipeline();
        client.ehmsetex(key, temporaryEntries);
        return client.getStatusCodeReply();
    }
    ...
    public Long ehincrBy(final String key, final String field, final long value) {
        checkIsInMultiOrPipeline();
        client.ehincrBy(key, field, value);
        return client.getIntegerReply();
    }
    ...
    public Double ehincrByFloat(final String key, final String field, final double value) {
        checkIsInMultiOrPipeline();
        client.ehincrByFloat(key, field, value);
        final String dval = client.getBulkReply();
        return (dval != null ? new Double(dval) : null);
    }
    ...
    public Long ehstrlen(final String key, final String field) {
        checkIsInMultiOrPipeline();
        client.ehstrlen(key, field);
        return client.getIntegerReply();
    }
